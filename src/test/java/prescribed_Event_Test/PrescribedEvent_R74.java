...
public class PrescribedEvent_R74 {
...
//	}
	...
	public void CreateNewEvent_R74() throws Exception {
		...
		ref.createEventForSBMA_R74();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.quebecFirstSponsorApprovalForEventCreation_PEQc5();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSecondSponsorR74() throws InterruptedException {
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.sponsor2LoginQc();
	...
	public void uploadEmmissionUnits() throws InterruptedException  {
		...
		ref.clickbtnAdmin();
		ref.clickbtnEvent();
		ref.getCurrentEvent_PEQc5();
		ref.uploadEmissionUnitsFileR74();
	...
	public void Placing_Bids_FirstAR_R74() throws Exception {
		testCaseId.set("41380");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.AR1LoginPEQcSBMA6();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_SBMA6();
		ref.changeLangauge();
		ref.selectEventForBidding_SBMA6();
		ref.BiddingByAR1_SBMA6();
