...
public class PrescribedEvent_A297  {
...
//	}
	...
	public void CreateNewEvent_A297() throws Exception {
		...
		ref.createEventForJointAuction_PE11();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.CaliforniaJuridictionApprovalForEventCreation_PE11();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSponsor_A297() throws InterruptedException {
	...
	public void SET_FXRATE_CA_A297() throws InterruptedException {
		testCaseId.set("42364");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
	    ref.sponsorLoginCa2();
	    ref.handleSecurityQue();
	...
	public void PlacingBidsByCaliforniaAR_A297() throws Exception {
		testCaseId.set("42177");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE11();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_PE11();
		ref.selectEventForBidding_PE11();
		ref.BiddingByCaAR_PE11();
	...
	public void PlacingBidsByQuebecAR_A297() throws Exception {
		testCaseId.set("42180");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginQC_PE11();
		ref.handleSecurityQue();
		ref.clickOnnextQC();
		ref.SelectEntity4_PE11();
		ref.changeLangauge();
		ref.selectEventForBidding_PE11();
		ref.BiddingByQcAR_PE11();
