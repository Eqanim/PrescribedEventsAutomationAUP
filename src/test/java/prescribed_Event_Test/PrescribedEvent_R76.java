...
public class PrescribedEvent_R76 {
...
//	}
	...
	public void CreateNewEvent_R76() throws Exception {
		...
		ref.createEventForSBMA_R76();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.quebecFirstSponsorApprovalForEventCreation_PEQc6();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSecondSponsorR76() throws InterruptedException {
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.sponsor2LoginQc();
	...
	public void uploadEmmissionUnits() throws InterruptedException  {
		...
		ref.clickbtnAdmin();
		ref.clickbtnEvent();
		ref.getCurrentEvent_PEQc6();
		ref.uploadEmissionUnitsFileR76();
	...
	public void Placing_Bids_FirstAR_R76() throws Exception {
		testCaseId.set("41380");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.AR1LoginPEQcSBMA7();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_SBMA7();
		ref.changeLangauge();
		ref.selectEventForBidding_SBMA7();
		ref.BiddingByAR1_SBMA7();
