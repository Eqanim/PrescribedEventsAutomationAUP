...
public class PrescribedEvent_R71 {
...
//	}
	...
	public void CreateNewEvent_R71() throws Exception {
		...
		ref.createEventForSBMA_R71();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.quebecFirstSponsorApprovalForEventCreation_PEQc2();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSecondSponsorR71() throws InterruptedException {
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.sponsor2LoginQc();
	...
	public void uploadEmmissionUnits() throws InterruptedException  {
		...
		ref.clickbtnAdmin();
		ref.clickbtnEvent();
		ref.getCurrentEvent_PEQc2();
		ref.uploadEmissionUnitsFileR71();
	...
	public void Placing_Bids_FirstAR_R71() throws Exception {
		testCaseId.set("41380");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.AR1LoginPEQcSBMA3();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_SBMA3();
		ref.changeLangauge();
		ref.selectEventForBidding_SBMA3();
		ref.BiddingByAR1_SBMA3();
