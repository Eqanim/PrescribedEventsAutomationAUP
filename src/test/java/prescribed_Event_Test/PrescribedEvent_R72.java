...
public class PrescribedEvent_R72 {
...
//	}
	...
	public void CreateNewEvent_R72() throws Exception {
		...
		ref.createEventForSBMA_R72();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.quebecFirstSponsorApprovalForEventCreation_PEQc3();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSecondSponsorR72() throws InterruptedException {
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.sponsor2LoginQc();
	...
	public void uploadEmmissionUnits() throws InterruptedException  {
		...
		ref.clickbtnAdmin();
		ref.clickbtnEvent();
		ref.getCurrentEvent_PEQc3();
		ref.uploadEmissionUnitsFileR72();
	...
	public void Placing_Bids_FirstAR_R72() throws Exception {
		testCaseId.set("41380");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.AR1LoginPEQcSBMA4();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_SBMA4();
		ref.changeLangauge();
		ref.selectEventForBidding_SBMA4();
		ref.BiddingByAR1_SBMA4();
