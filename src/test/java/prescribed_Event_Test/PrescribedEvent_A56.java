...
public class PrescribedEvent_A56  {
	
//	@Test
//	public void Reset_Citss_EventID_A56()
//			throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
//		DataBAseQueriesMethod.setConnection();
//		DataBAseQueriesMethod ref = new DataBAseQueriesMethod();
//		ref.updateCittsEventID_PE9();
//	}

	@Test(priority = 1, retryAnalyzer = analyzer.RetryAnalyzer.class)//, dependsOnMethods = "Reset_Citss_EventID_A56")
	public void CreateNewEvent_A56() throws Exception {
		testCaseId.set("42048");
		...
		ObjectRepo.test.log(Status.PASS, "Security Question handled Successfully");
		ref.createEventForJointAuction_PE9();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.CaliforniaJuridictionApprovalForEventCreation_PE9();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSponsor_A56() throws InterruptedException {
		testCaseId.set("42049");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.sponsorLoginQc();
	...
	public void SET_FXRATE_CA_A56() throws InterruptedException {
		testCaseId.set("42363");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
	ref.sponsorLoginCa2();
	ref.handleSecurityQue();
	ref.clickOnnext();
	ref.setFXrateCal_PE9();
	...
	public void Placing_Bids_FirstEntity_A56() throws Exception {
		testCaseId.set("42051");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_PE9();
		ref.selectEventForBidding_PE9();
		ref.BiddingByARforTestData1_PE9();
		System.out.println("First bid placed ");
		 ObjectRepo.test.log(Status.PASS, "First bid placed ");
		ref.BiddingByARforTestData2_PE9();
		System.out.println("Second bid placed ");
		 ObjectRepo.test.log(Status.PASS, "Second bid placed ");
		ref.BiddingByARforTestData3_PE9();
		System.out.println("Third bid placed ");
		 ObjectRepo.test.log(Status.PASS, "Third bid placed");
		 ref.BiddingByARforTestData4_PE9();
