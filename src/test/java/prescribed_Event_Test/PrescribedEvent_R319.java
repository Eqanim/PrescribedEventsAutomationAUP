...
public class PrescribedEvent_R319 {
...
//	}
	...
	public void CreateNewEvent_R319() throws Exception {
		...
		ref.createEventForWaReserveSaleEvent_REWA1();
	...
	public void Approval_By_WaSecondSponsorR319() throws InterruptedException {
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.sponsorLoginWa2();
	...
	public void Placing_Bids_AR_R319() throws Exception {
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker();
		ref.ARLoginREWA1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_REWA1();
		ref.selectEventForBidding_REWA1();
		ref.BiddingByAR_REWA1();
