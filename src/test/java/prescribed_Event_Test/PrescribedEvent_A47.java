...
public class PrescribedEvent_A47 {
//	@Test
//	public void Reset_Citss_EventID_A47()
//			throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
//		DataBAseQueriesMethod.setConnection();
//		DataBAseQueriesMethod ref = new DataBAseQueriesMethod();
//		ref.updateCittsEventID_PE4();
//	}

	@Test(priority = 1, retryAnalyzer = analyzer.RetryAnalyzer.class)//, dependsOnMethods = "Reset_Citss_EventID_A47")
	public void CreateNewEvent_A47() throws Exception {
		testCaseId.set("41469");
		...
		ref.createEventForJointAuction_PE4();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.CaliforniaJuridictionApprovalForEventCreation_PE4();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSponsor_A47() throws InterruptedException {
		testCaseId.set("41470");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.sponsorLoginQc();
	...
	public void SET_FXRATE_CA_A47() throws InterruptedException {
		testCaseId.set("42358");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
	...
	public void Placing_Bids_FirstEntity_A47() throws Exception {
		testCaseId.set("41472");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_PE4();
		ref.selectEventForBidding_PE4();
	...
	public void Placing_Bids_SecondEntity_A47() throws Exception {
		testCaseId.set("41473");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity2_PE4();
		ref.selectEventForBidding_PE4();
	...
	public void Placing_Bids_ThirdEntity_A47() throws Exception {
		testCaseId.set("41474");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity3_PE4();
		ref.selectEventForBidding_PE4();
	...
	public void Placing_Bids_FourthEntity_A47() throws Exception {
		testCaseId.set("41475");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity4_PE4();
		ref.selectEventForBidding_PE4();
	...
	public void Placing_Bids_FifthEntity_A47() throws Exception {
		testCaseId.set("41476");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginQC_PE1();
		ref.handleSecurityQue();
		ref.clickOnnextQC();
		ref.SelectEntity5_PE4();
		ref.changeLangauge();
		ref.selectEventForBidding_PE4();
		...
		System.out.println("19th bid placed ");
		 ...
		 ref.BiddingByARforTestData20_PE4();
