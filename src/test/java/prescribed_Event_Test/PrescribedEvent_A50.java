...
public class PrescribedEvent_A50 {
	
//	@Test
//	public void Reset_Citss_EventID_A50()
//			throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
//		DataBAseQueriesMethod.setConnection();
//		DataBAseQueriesMethod ref = new DataBAseQueriesMethod();
//		ref.updateCittsEventID_PE7();
//	}

	@Test(priority = 1, retryAnalyzer = analyzer.RetryAnalyzer.class)//, dependsOnMethods = "Reset_Citss_EventID_A50")
	public void CreateNewEvent_A50() throws Exception {
		testCaseId.set("41979");
		...
		ref.createEventForJointAuction_PE7();
		ObjectRepo.test.log(Status.PASS, "Event Created Successfully");
		ref.CaliforniaJuridictionApprovalForEventCreation_PE7();
		System.out.println("******************************************************************");
	}

	@Test(priority = 2, retryAnalyzer = analyzer.RetryAnalyzer.class)
	public void Approval_By_QuebecSponsor_A50() throws InterruptedException {
		testCaseId.set("41980");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.sponsorLoginQc();
	...
	public void SET_FXRATE_CA_A50() throws InterruptedException {
		testCaseId.set("42361");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
	...
	public void Placing_Bids_FirstEntity_A50() throws Exception {
		testCaseId.set("41982");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity1_PE7();
		ref.selectEventForBidding_PE7();
	...
	public void Placing_Bids_SecondEntity_A50() throws Exception {
		testCaseId.set("41983");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity2_PE7();
		ref.selectEventForBidding_PE7();
	...
	public void Placing_Bids_ThirdEntity_A50() throws Exception {
		testCaseId.set("41984");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity3_PE7();
		ref.selectEventForBidding_PE7();
	...
	public void Placing_Bids_FourthEntity_A50() throws Exception {
		testCaseId.set("41985");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginCA_PE1();
		ref.handleSecurityQue();
		ref.clickOnnext();
		ref.SelectEntity4_PE7();
		ref.selectEventForBidding_PE7();
	...
	public void Placing_Bids_FifthEntity_A50() throws Exception {
		testCaseId.set("41986");
		com_pomClassForJointAuctionTieBreaker ref = new com_pomClassForJointAuctionTieBreaker( );
		ref.ARLoginQC_PE1();
		ref.handleSecurityQue();
		ref.clickOnnextQC();
		ref.SelectEntity5_PE7();
		ref.changeLangauge();
		ref.selectEventForBidding_PE7();
