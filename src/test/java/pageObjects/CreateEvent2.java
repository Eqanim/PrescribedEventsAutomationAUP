...
import resources.WaitStatementLib;
...
public class CreateEvent2 {
	...
	@FindBy(xpath = "(//*[@aria-label='Without label'])[3]")
	private WebElement currencyAccforSBANS;
	...
	@FindBy(xpath = "//p[text()='FirstEvent']")
	...
	@FindBy(xpath = "//th[text()='Event Date']")
	...
	public void AuctionCertificationButtonca() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOf(AuctionCertificationButton));
		...
		wait.until(ExpectedConditions.visibilityOf(submitBtncertification));
	...
	public void AuctionCertificationButtonCA2() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOf(AuctionCertificationButton));
		AuctionCertificationButton.click();
		wait.until(ExpectedConditions.visibilityOf(CA2certificationbutton));
		...
		wait.until(ExpectedConditions.visibilityOf(submitBtncertification));
		submitBtncertification.click();
		wait.until(ExpectedConditions.visibilityOf(submitBtncertificationsubmitpopup));
	...
	public void runAlgorithmWA() throws InterruptedException {
		...
		commonLib lib = new commonLib();
		try {
			lib.scroll(btnRunAlgorithmWA, "scrollToElement", "Move to Run Algorithm");
			lib.click(btnRunAlgorithmWA, "seleniumClick", "click on Run Algorithm");
		} catch (Exception e) {
			lib.scroll(btnRunAlgorithmWA2, "scrollToElement", "Move to Run Algorithm ");
			lib.click(btnRunAlgorithmWA2, "seleniumClick", "click on Run Algorithm");
		}
	...
	public void createEventJointAuctionForARTestcases() throws Exception {
	...
	public void QcSecondApprovalBySameJurisdiction() throws InterruptedException {
		...
		WebElement element = driver.get().findElement(
				By.xpath("(//*[@title='Go to details of Event " + prop.getProperty("Event_NameForQC1") + "'])[1]"));
		JavascriptExecutor js = (JavascriptExecutor) driver.get();
		js.executeScript("arguments[0].scrollIntoView();", element);
		element.click();
		try {
			WaitStatementLib.threadSleepOfMilliSecond(5000);
	...
	public void createEventForReserveSaleForQC1() throws Exception {
		clickbtnAdmin();
		clickbtnEvent();
		clickbtnCreateEvent();
		gettextBoxEventForQC();  
		selectReserveSaleEventTypeforQCFromDropDown();
		enterEventNameFor_QC();
		enterfrenchEventName();
		currencyAccForReserveSaleForQC();
		selectTiers1();
		selectTiers2();
	...
	public void createEventSBAForNS() throws Exception {
		clickbtnAdmin();
		clickbtnEvent();
		clickbtnCreateEvent();
		gettextBoxEventForNS(); 
		selectEventTypeSBAforNSFromDropDown();
		enterEventNameForNS();
		currencyAccForSBAForNS();
		selectTiers1();
		selectTiers2();
		selectTiers3(); 
		ObjectRepo.test.log(Status.PASS, "step 9 : Selected 3 tiers");
	...
	public void clickbtnAdmin() throws IOException {
		try {
			 
			WebElement abc = wait.until(ExpectedConditions.visibilityOf(btnAdminstration));
			action = new Actions(driver.get());
			action.click(abc).build().perform();
	...
	public void gettextBoxEventForNS() {
		int length = 12;
		boolean useLetters = true;
		boolean useNumbers = true;
		String generatedString = RandomStringUtils.random(length, useLetters, useNumbers);
	...
	public void enterEventNameForNS() {
	...
	public void selectEventTypeSBAforNSFromDropDown() {
		wait.until(ExpectedConditions.elementToBeClickable(eventTypeDropDown));
		WebElement eventType = eventTypeDropDown;
		Select s = new Select(eventType);
		try {
		...
		ObjectRepo.test.log(Status.PASS, "step 5 : Select Sale by Agreement Event From Dropdown");
	}
	...
	public void enterEventNameFor_QC() {
		wait.until(ExpectedConditions.elementToBeClickable(eventName));
		eventName.sendKeys(prop.getProperty("Event_NameForQC1"));
		ObjectRepo.test.log(Status.PASS, "step 6 : Entered event name in english");
	}

	public void enterEventNameForQC1() {
		int length = 12;
		boolean useLetters = true;
		boolean useNumbers = true;
		String generatedString = RandomStringUtils.random(length, useLetters, useNumbers);
	...
	public void selectJurisdictionForJointAuction() {
		...
		action.clickAndHold(abc2).build().perform();
		action.click(abc2).build().perform();
		frenchEventName.sendKeys("Ã‰vÃ©nement test");
	}
	...
	public void currencyAccForSBAForNS() {
		 
		wait.until(ExpectedConditions.elementToBeClickable(currencyAccforSBANS));
		WebElement element = currencyAccforSBANS;
		JavascriptExecutor js = (JavascriptExecutor) driver.get();
		js.executeScript("arguments[0].scrollIntoView();", element);
		action.moveToElement(element).click().build().perform();
		Select s = new Select(element);
	...
	public void editFinancialGuaranteeSubmissionDeadlineClosedEvent() throws Exception {
		...
		Actions action = new Actions(driver.get());
		action.click(element1).build().perform();
		// Step7: Assert Edited Event Page
		...
		// Step8: Edit Event
		wait.until(ExpectedConditions.elementToBeClickable(editEvent)).click();
		// Step9: Change Financial Guarantee Submission Deadline date and time
		// // 
	...
	public void editClosedEvent() throws Exception {
		...
		try {
			wait.until(ExpectedConditions.visibilityOf(editEvent));
	...
	public void listOfEvents() throws Exception {
		...
		// Event Grid Column Names Assertion
...
//		System.out.println(msg);
//		Assert.assertEquals("The event has been created successfully.", msg);
//		ObjectRepo.test.log(Status.PASS, "Step 12 : The SBMA event has been created successfully with Combined Evaluation of Categories");	
	}
	...
	public void verifyDisapprovaFromSponsor() throws Exception {
		...
		// Verify the status of rejected event by only one sponsor
		CreateEvent ref = new CreateEvent( );
		wait.until(ExpectedConditions.elementToBeClickable(btnHome)).click();
		ref.clickbtnAdmin();
		ref.clickbtnEvent();
	...
	public void verifyAlphanumericEventID() throws Exception {
		...
		action.moveToElement(abc).build().perform();
		action.click(abc).build().perform();
		// Step12: Change Event Type to SBMA
		ref.selectEventTypeFromDropDown1();
		 
		// Step13: Assert selected Event Type
		...
		// Step14: Enter Event ID for SBMA
		wait.until(ExpectedConditions.elementToBeClickable(enterEventID)).click();
	...
	public void verifyEventNeedsDualSponsorApproval() throws Exception {
		// Edit any already created event
	...
	public void clearThesearchForMMOnMonotoringPage() {
		...
		// Step9: Assert Total number of bids available
		listOfSubmittedBids();
		// STep10: Search Bid Details using Transaction ID
	...
	public void contactUsPage() throws Exception {
		...
		action.click(elemen).build().perform();
	...
	public void HappyPathcontactUsPage() {
	...
	public void NegativePathcontactUsPage() {
		wait.until(ExpectedConditions.elementToBeClickable(contactMenu));
		contactMenu.click();
		wait.until(ExpectedConditions.visibilityOf(name));
		name.sendKeys("1223e");
	...
	public void deleteTheTierRowBeingOfferedForReserveSale() {
		...
		wait.until(ExpectedConditions.visibilityOf(processingOrderDltBtn2)).click();
	...
	public void allowancesPerBidLotAdditionalSettingPlusMinus() {
		...
		wait.until(ExpectedConditions.visibilityOf(allowancesPerBidLotPls)).click();
	...
	public void limitMaximumBidsAllowedFunctionality() {
		...
		wait.until(ExpectedConditions.visibilityOf(limitMaximumBidAllowedRadioBtn)).click();
	...
	public void SecondApprovalBySameJurisdiction() throws IOException, InterruptedException {
	...
	public void RollDownProcessForReserveSaleNewEvent() throws IOException, InterruptedException {
		...
		ref.gettextBoxEvent();
		// Step 6 : Select Reserve sale event from dropdown
		ref.selectReserveSaleEventTypeforCAFromDropDown();
		// Step 7 : Enter a event name in english
		ref.enterEventName();
		 
		// Step 8 : Click on Currency details and select currency
		ref.currencyAccForReserveSaleForCA();
		CreateEvent abc = new CreateEvent( );
		// Step Select tier 1 and click on roll down radio button
		abc.selectTiers1();
		try {
			rollDownbids.click();
			System.out.println(
		...
		// Step Select tier 2 and click on roll down radio button
		abc.selectTiers2();
		try {
			rollDownbids.click();
			System.out.println(
	...
	public void selectradioLimitMaximumBidAllowance() {
	...
	public void runtimesponsorLoginCa() {
		try {
			...
			ObjectRepo.test.log(Status.PASS, "Sponsor Username Entered  : " + prop.getProperty("UserSponsorWS2"));
			password.sendKeys("Test@1234");
			ObjectRepo.test.log(Status.PASS, "Sponsor Password Entered  : " + "Test@1234");
			wait.until(ExpectedConditions.visibilityOf(btnLogin));
			btnLogin.click();
			System.out.println("" + prop.getProperty("UserSponsorWS2") + " Sponsor (California) login successfully");
			ObjectRepo.test.log(Status.PASS,
					"" + prop.getProperty("UserSponsorWS2") + " Sponsor (California) login successfully");
		} catch (Exception e) {
			wait.until(ExpectedConditions.elementToBeClickable(btnLogin));
			btnLogin.click();
			wait.until(ExpectedConditions.visibilityOf(username));
	...
	public void AllowancesPerBidLot() {
		...
		act.doubleClick(textbox2).perform();
		allowancesPerBidLot.sendKeys("2");
		...
		act.doubleClick(textbox3).perform();
		wait.until(ExpectedConditions.visibilityOf(AllowancesPerBidLot));
		allowancesPerBidLot.sendKeys("9998");
	...
	public void BtnNextEventDetails() { 
	...
	public void firstApprovalEvent() throws IOException {
		clickbtnAdmin();
	...
	public void DisapprovalEvent2() { /// ------------dispute event
		JavascriptExecutor js = (JavascriptExecutor) driver.get();
		wait.until(ExpectedConditions.elementToBeClickable(btnAdminstration));
		btnAdminstration.click();
		wait.until(ExpectedConditions.elementToBeClickable(btnEvent));
	...
	public void completelistofevents() throws IOException {  
		clickbtnAdmin();
		ObjectRepo.test.log(Status.PASS, "Step 1: Click on Administration ");
		clickbtnEvent();
		ObjectRepo.test.log(Status.PASS, "Step 2: Click on Event ");
	...
	public void ResumeEventFunctionality() throws Exception {
		 
		clickbtnAdmin();
		System.out.println("Click on Adminstration button");
		clickbtnEvent();
		System.out.println("Click on Event button");
		 
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//button[@aria-label='Select number of rows per page.']")));
		driver.get().findElement(By.xpath("//button[@aria-label='Select number of rows per page.']")).click();
		System.out.println("Selected number of rows per page");
		ObjectRepo.test.log(Status.PASS, "Selected number of rows per page");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[@role='menuitem'])[5]")));
		driver.get().findElement(By.xpath("(//*[@role='menuitem'])[5]")).click();
		System.out.println("Selected 500 menuitem number of rows per page");
		ObjectRepo.test.log(Status.PASS, "Selected 500 menuitem number of rows per page");
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[@aria-label='Go to details of Event " + prop2.getProperty("Pause_Event_Name") + "']")));
		driver.get()
				.findElement(By.xpath(
						"//*[@aria-label='Go to details of Event " + prop2.getProperty("Pause_Event_Name") + "']"))
				.click();
		System.out.println("Event name is selected");
		ObjectRepo.test.log(Status.PASS, "Event name is selected");
		JavascriptExecutor js1 = (JavascriptExecutor) driver.get();
		WebElement element1 = driver.get().findElement(By.xpath("(//*[text()='RESUME'])[1]"));
		js1.executeScript("arguments[0].scrollIntoView();", element1);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[text()=RESUME'])[1]")));
		driver.get().findElement(By.xpath("(//*[text()='RESUME'])[1]")).click();
		 
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='CONTINUE']")));
		driver.get().findElement(By.xpath("//*[text()='CONTINUE']")).click();
	}
	...
	public void Re_RunAlgorithmFunctionality() throws Exception {
		...
		ObjectRepo.test.log(Status.PASS, "Selected 500 menuitem number of rows per page");
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[@aria-label='Go to details of Event " + prop2.getProperty("Event_Name_Status") + "']")));
		driver.get()
				.findElement(By.xpath(
						"//*[@aria-label='Go to details of Event " + prop2.getProperty("Event_Name_Status") + "']"))
				.click();
		System.out.println("Event name is selected");
		ObjectRepo.test.log(Status.PASS, "Event name is selected");
		String Status1 = driver.get().findElement(By.xpath(("(//*[text()='RUN ALGORITHM'])[1]"))).getText();
		System.out.println(Status1);
		Boolean BtnDisabled = driver.get().findElement(By.xpath(("(//*[text()='RUN ALGORITHM'])[1]"))).isSelected();
		Assert.assertFalse(BtnDisabled);
		System.out.println("First run algorithm button is enabled :- " + BtnDisabled);
		ObjectRepo.test.log(Status.PASS, "First run algorithm button is enabled :- " + BtnDisabled);

		String Strg1 = driver.get().findElement(By.xpath(("(//*[text()='RUN ALGORITHM'])[1]"))).getText();
		System.out.println(Strg1);
		Boolean Soft = driver.get().findElement(By.xpath(("(//*[text()='RUN ALGORITHM'])[1]"))).isSelected();
		Assert.assertFalse(Soft);
		System.out.println("Second run algorithm button is enabled :- " + Soft);
		ObjectRepo.test.log(Status.PASS, "Second run algorithm button is enabled :- " + Soft);
	}

	public void PauseResumeEventFunctionality() throws Exception {
		...
		ObjectRepo.test.log(Status.PASS, "Event name is selected");
		JavascriptExecutor js1 = (JavascriptExecutor) driver.get();
		WebElement element1 = driver.get().findElement(By.xpath("(//*[text()='PAUSE'])[1]"));
		js1.executeScript("arguments[0].scrollIntoView();", element1);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[text()='PAUSE'])[1]")));
		driver.get().findElement(By.xpath("(//*[text()='PAUSE'])[1]")).click();
		 
		POM_ApprovalStatus ref2 = new POM_ApprovalStatus( );
		ref2.Logout2();
		...
		System.out.println("Event name is selected");
		ObjectRepo.test.log(Status.PASS, "Event name is selected");
		WebElement element = driver.get().findElement(By.xpath("(//*[text()='PAUSE'])[2]"));
		js1.executeScript("arguments[0].scrollIntoView();", element);
		 
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[text()='PAUSE'])[2]")));
		driver.get().findElement(By.xpath("(//*[text()='PAUSE'])[2]")).click();
		 
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='CONTINUE']")));
		driver.get().findElement(By.xpath("//*[text()='CONTINUE']")).click();
		String Pause = driver.get().findElement(By.xpath("//*[text()='Event pause approved and effective.']"))
				.getText();
		System.out.println(Pause);
		 
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[text()='RESUME'])[2]")));
		driver.get().findElement(By.xpath("(//*[text()='RESUME'])[2]")).click();
		System.out.println("Event successfully paused by sponsor");
		 
		ref2.Logout2();
	}

	public void RuntimeARLoginQCForSBMA_R70() throws InterruptedException {
