...
public class com_pomClassForSingleAuctionCaliforniaJurisdiction {
	...
	@FindBy(xpath = "(//input[@type='checkbox'])[2]")
	private WebElement tagCAD_Single_Auction;
	...
	public com_pomClassForSingleAuctionCaliforniaJurisdiction() {
	...
	public void searchQualifiedbidderReportFunctionality() throws InterruptedException {
		try {
			...
			new WebDriverWait(driver.get(), Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(btnReports));
			btnReports.click();
			WebElement element = new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.elementToBeClickable(btnSearchReports));
			...
			WebElement element1 = new WebDriverWait(driver.get(), Duration.ofSeconds(30))
			...
			WebElement element2 = new WebDriverWait(driver.get(), Duration.ofSeconds(30))
			...
			btnReports.click();
			WebElement element = new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.visibilityOf(btnSearchReports));
			Actions action = new Actions(driver.get());
			action.moveToElement(element).build().perform();
			action.click(element).build().perform();
			btnSearchReports.click();
	...
	public void eventCertification() throws InterruptedException {
		com_pomClassForSingleAuctionCaliforniaJurisdiction login = new com_pomClassForSingleAuctionCaliforniaJurisdiction();
	...
	public void searchFinancialSettlementReportFunctionality() throws InterruptedException {
		try {
			...
			driver.get().findElement(By.xpath("//*[contains(text(),'" + prop.getProperty("Event_Name") + "')]"))
					.click();
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(btnParticularEvent));
			driver.get().findElement(btnParticularEvent).click();
			 
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(btnDownloadFinancialReport));
			...
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.visibilityOfElementLocated(btnDownloadFinancialReport));
			driver.get().findElement(btnDownloadFinancialReport).click();
		}
	}
	...
	public void clickbtnCreateEvent() {
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(btnCreateEvent));
	...
	public void gettextBoxEvent() {
		...
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(textBoxEventID));
	...
	public void enterEventName() {
		eventName.sendKeys(eventNameCA);
	}

	public void enterEventNameQC() {
		eventName.sendKeys(eventNameQC);
	}
	...
	public void selectVintage() {
		...
		textBoxVintage1.sendKeys(prop.getProperty("TotalAllowancesCA"));
	}
	...
	public void CaliforniaJuridictionApprovalForEventCreation() throws InterruptedException {
		...
		js.executeScript("arguments[0].scrollIntoView();", element1);
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(eventDetailsBtn));
		Actions action = new Actions(driver.get());
		action.click(element1).build().perform();
		new WebDriverWait(driver.get(), Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(btnApproveCal));
		btnApproveCal.click();
		new WebDriverWait(driver.get(), Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(btnSubmit1));
		btnSubmit1.click();
	...
	public void secondApproval() throws InterruptedException {
		com_pomClassForSingleAuctionCaliforniaJurisdiction ref = new com_pomClassForSingleAuctionCaliforniaJurisdiction();
		ref.clickbtnAdmin();
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(btnEvent));
		btnEvent.click();
		...
		try {
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.elementToBeClickable(btnApprovalQue));
	...
	public void executeAPIGetQualifiedBidder() {
		try {
			...
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.elementToBeClickable(btnSettings));
			...
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.elementToBeClickable(btnExecuteAPI));
			btnExecuteAPI.click();
			JavascriptExecutor js = (JavascriptExecutor) driver.get();
			WebElement element1 = APIGetQualifiedBidder;
			js.executeScript("arguments[0].scrollIntoView();", element1);
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.visibilityOf(APIGetQualifiedBidder));
	...
	public void SelectEntity1() throws InterruptedException {
		...
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(btnEntity5));
	...
	public void BiddingByARforTestData1() throws IOException, InterruptedException {
		...
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(alertMsg2));
	...
	public void BiddingByARforTestData9() throws Exception {
		...
		try {
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.elementToBeClickable(alertMsg));
		...
		System.out.println(Massage2);
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(alertPopup)).click();
		;
	}
	...
	public void SelectEntity2() throws InterruptedException {
		...
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(btnEntity6));
	...
	public void SelectEntity3() throws InterruptedException {
		...
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(btnEntity7));
	...
	public void Logout() throws InterruptedException {
		try {
			...
			new WebDriverWait(driver.get(), Duration.ofSeconds(30))
					.until(ExpectedConditions.elementToBeClickable(btnProfile));
			btnProfile.click();
			btnLogout.click();
		} catch (Exception e) {
			driver.get().navigate().refresh();
	...
	public void searchReportFunctionalityForCalIndAuction() throws InterruptedException {
		...
		action.click(element1).build().perform();
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.visibilityOfElementLocated(btnDownloadResultReportForCalReserveSale));
	...
	public void SecondApprovalBySameJurisdiction() throws InterruptedException {
		...
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(btnSubmit1));
		btnSubmit1.click();
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
	...
	public void firstApproval() throws InterruptedException {
		...
		WebElement element = driver.get().findElement(By.xpath("(//button[@type='button'])[10]"));
		try {
			 
			driver.get().findElement(By.xpath("(//button[@type='button'])[10]")).click();
		} catch (Exception e) {
			element.click();
		}
		 
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(btnfirstApproval));
	...
	public void gettextBoxEventForCA() {
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(textBoxEventID));
		textBoxEventID.sendKeys(prop.getProperty("CAAuctionEventID"));
	...
	public void gettextBoxEventForQC() {
		new WebDriverWait(driver.get(), Duration.ofSeconds(30))
				.until(ExpectedConditions.elementToBeClickable(textBoxEventID));
		textBoxEventID.sendKeys(prop.getProperty("QCAuctionEventID"));
		ObjectRepo.test.log(Status.PASS, "step 4 : Entered Citts Event ID");
	}
	...
	public void selectJurisdiction() throws InterruptedException {
		...
		action.clickAndHold(abc2).build().perform();
		action.click(abc2).build().perform();
		frenchEventName.sendKeys("frenchEVentName");
	}

	public void selectJurisdictionForCalSingleAuction() throws InterruptedException {
		ParticipatingJurisdictions.click();
		try {
			btnCalifornia.click();
		} catch (Exception e) {
		...
		action.clickAndHold(abc2).build().perform();
		action.click(abc2).build().perform();
		frenchEventName.sendKeys(eventNameCA);
	}

	public void selectJurisdictionQC() throws InterruptedException {
		ParticipatingJurisdictions.click();
		try {
			btnQuebec.click();
		} catch (Exception e) {
		...
		action.clickAndHold(abc2).build().perform();
		action.click(abc2).build().perform();
		frenchEventName.sendKeys(eventNameQC);
	}

	public void currencyAccForCal() throws InterruptedException {
		try {
		...
		action.click(abc4).build().perform();
		textBoxUSD.sendKeys(prop.getProperty("CAFloorPriceUSD"));
	}

	public void currencyAccForQC() throws InterruptedException {
		try {
		...
		action.clickAndHold(abc4).build().perform();
		action.click(abc4).build().perform();
		textBoxCAD.sendKeys(prop.getProperty("QCFloorPriceCAD"));
	}
	...
	public void createEventForCal() throws Exception {
		...
		clickbtnCreateEvent();
		generateString();
		gettextBoxEventForCA(); // Event Id
		selectEventTypeFromDropDown();
		enterEventName();
		selectJurisdictionForCalSingleAuction();
		currencyAccForCal();
	...
	public void createEventForQC() throws Exception {
		clickbtnAdmin();
		clickbtnEvent();
		clickbtnCreateEvent();
		generateString();
		gettextBoxEventForQC(); // Event Id
		selectEventTypeFromDropDown();
		enterEventNameQC();
		selectJurisdictionQC();
		currencyAccForQC();
		driver.get().findElement(By.xpath("(//button[@class='MuiButtonBase-root MuiIconButton-root'])[1]")).click();
		selectVintage();
		selectVintageType();
