...
public class ExcelDataProviderforResultReportRS_WA {
	XSSFWorkbook wb;

	public ExcelDataProviderforResultReportRS_WA() throws Exception {
//		File src = new File("C:\\Users\\VishalGiram\\git\\wci-ap-endtoend-automation\\TestData\\Results Report - JOINT AUCTION NO LINK RnD 2 2 06-29-2022.xlsx");
		...
		File src = new File(folderPath+File.separator+"Results Report - " + ReserveSaleEventName_WA + " " + date1 + ".xlsx");
		try {
