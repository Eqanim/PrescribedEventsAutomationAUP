...
public class ExcelDataProviderforResultReportCA_Single_Auction {
	XSSFWorkbook wb;

	public ExcelDataProviderforResultReportCA_Single_Auction() throws Exception {
//		File src = new File("C:\\Users\\VishalGiram\\git\\wci-ap-endtoend-automation\\TestData\\Results Report - JOINT AUCTION NO LINK RnD 2 2 06-29-2022.xlsx");
		...
		File src = new File(folderPath+File.separator+"Results Report - " + eventNameCA + " " + date1 + ".xlsx");
		try {
