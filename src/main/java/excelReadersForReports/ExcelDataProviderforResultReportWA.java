...
public class ExcelDataProviderforResultReportWA extends commonLib{
	XSSFWorkbook wb;

	public ExcelDataProviderforResultReportWA() throws Exception {
//		File src = new File("C:\\Users\\VishalGiram\\git\\wci-ap-endtoend-automation\\TestData\\Results Report - JOINT AUCTION NO LINK RnD 2 2 06-29-2022.xlsx");
		...
		File src = new File(folderPath+File.separator+"Results Report - " + eventNameWS + " " + date1 + ".xlsx");
		try {
